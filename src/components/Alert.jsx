...
const Alert = ({ type, text }) => {
  return (
    <div className="absolute top-10 left-0 right-0 flex justify-center items-start"> {/* Adjusted alignment */}
      {/* Alert box with dynamic styling based on the type prop */}
