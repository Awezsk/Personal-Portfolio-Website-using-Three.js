...
function loadingFn(extensions, onProgress) {
  return function(Proto, ...input) {
    ...
    return Promise.all(input.map((input2) => new Promise((res, reject) => loader.load(input2, (data) => {
      ...
      res(data);
    }, onProgress, (error) => reject(new Error(`Could not load ${input2}: ${error == null ? void 0 : error.message}`)))))).finally(() => loader.dispose == null ? void 0 : loader.dispose());
  };
}
...
scheduler/cjs/scheduler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Y4PZAHOI.js.map
